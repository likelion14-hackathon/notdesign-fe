...
export default function WellnessSkincareCostPage() {
  const navigate = useNavigate()
  const amount = useWellnessStore((state) => state.skincareCost)
      ...
      <div className="px-5 pt-7.5">
        ...
        <div className="mt-20">
          <MoneySlider
            ...
            label={WELLNESS_SKINCARE_COST.sliderLabel}
          />
        </div>
      </div>
